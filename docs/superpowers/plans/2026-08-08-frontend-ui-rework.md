...
**Interfaces:**
- Produces: `StatDonut` component, props `value: number`, `label: string`. Consumed by Home page (Task 17). Decorative only (a fixed amber arc, not a real percentage of anything — there's no "total" to be a percentage of).
...
<div class="flex flex-col items-center gap-2">
	<svg width="96" height="96" viewBox="0 0 100 100" aria-hidden="true">
		<path d="M50 50 L50 5 A45 45 0 1 1 15 75 Z" fill="var(--color-accent)" />
	</svg>
	<p class="text-center">
...
{#if $activeUnit}
	...
	<div class="max-w-3xl mx-auto px-4 py-8 grid gap-4 md:grid-cols-2">
		...
		<SectionCard>
			<StatDonut value={mockStudents.length} label="students have registered in TeamUp!" />
		</SectionCard>
